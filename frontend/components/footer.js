    ...
    this.shadowRoot.innerHTML = `
      <style>
        footer {
          ...
          padding: 3rem 0;
          border-block-start: 1px solid #1e293b; /* Slate 800 */
      ...
      <footer>
        <div class="container">
            <div class="socials">
                <a href="https://www.linkedin.com/in/kekeletso-basholo-161059247/" class="social-link">
                ...
                <a href="https://github.com/Unathi-2" class="social-link">
            ...
            <p>&copy; 2025 Kekeletso Basholo. All systems normal.</p>
        </div>
      </footer>
    `;
  }
